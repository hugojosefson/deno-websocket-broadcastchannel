...
import { ConnectorOptions, DEFAULT_CONNECTOR_OPTIONS } from "./types.ts";
...
async function main(options: ConnectorOptions = DEFAULT_CONNECTOR_OPTIONS) {
  const listenOptions: ConnectorOptions = {
